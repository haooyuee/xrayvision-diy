...
weights_files = glob(join(cfg.output_dir, f'nih-densenet-nonlocal-best.pt'))
print("weights_files=",weights_files)
model.load_state_dict(torch.load(weights_files[0]).state_dict())
